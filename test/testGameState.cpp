...
TEST_F(GameStateTest, GameStateGameFlowIsCorrect)
{
    ...
    //-- Left
    mockupInputManager->sendKeyDown(RdKey(RdKey::KEY_ARROW_LEFT));
    yarp::os::Time::delay(0.5);
    ...
    mockupInputManager->sendKeyUp(RdKey(RdKey::KEY_ARROW_LEFT));
    yarp::os::Time::delay(0.5);
    ...
    //-- Right
    mockupInputManager->sendKeyDown(RdKey(RdKey::KEY_ARROW_RIGHT));
    yarp::os::Time::delay(0.5);
    ASSERT_TRUE(mockupRobotManager->isMoving());
    ASSERT_EQ(RdMockupRobotManager::RIGHT,((RdMockupRobotManager *)robotManager)->getMovementDirection());
    mockupInputManager->sendKeyUp(RdKey(RdKey::KEY_ARROW_RIGHT));
    yarp::os::Time::delay(0.5);
    ASSERT_FALSE(mockupRobotManager->isMoving());
    ASSERT_EQ(RdMockupRobotManager::NONE, ((RdMockupRobotManager *)robotManager)->getMovementDirection());
    //-- Forward
    mockupInputManager->sendKeyDown(RdKey(RdKey::KEY_ARROW_UP));
    yarp::os::Time::delay(0.5);
    ASSERT_TRUE(mockupRobotManager->isMoving());
    ASSERT_EQ(RdMockupRobotManager::FORWARD, ((RdMockupRobotManager *)robotManager)->getMovementDirection());
    mockupInputManager->sendKeyUp(RdKey(RdKey::KEY_ARROW_UP));
    yarp::os::Time::delay(0.5);
    ASSERT_FALSE(mockupRobotManager->isMoving());
    ASSERT_EQ(RdMockupRobotManager::NONE, ((RdMockupRobotManager *)robotManager)->getMovementDirection());
    //-- Backwards
    mockupInputManager->sendKeyDown(RdKey(RdKey::KEY_ARROW_DOWN));
    yarp::os::Time::delay(0.5);
    ASSERT_TRUE(mockupRobotManager->isMoving());
    ASSERT_EQ(RdMockupRobotManager::BACKWARDS, ((RdMockupRobotManager *)robotManager)->getMovementDirection());
    mockupInputManager->sendKeyUp(RdKey(RdKey::KEY_ARROW_DOWN));
    yarp::os::Time::delay(0.5);
    ASSERT_FALSE(mockupRobotManager->isMoving());
    ASSERT_EQ(RdMockupRobotManager::NONE, ((RdMockupRobotManager *)robotManager)->getMovementDirection());
    ...
    mockupInputManager->sendKeyPress(RdKey(RdKey::KEY_SPACE));
    ...
    mockupInputManager->sendKeyPress(RdKey('r'));
