...
bool rd::Screen::update(const std::string & parameter, std::vector<rd::Player> value)
{
    return true;
}

bool rd::Screen::update(const std::string & parameter, std::vector<rd::Target> value)
{
    return true;
}
