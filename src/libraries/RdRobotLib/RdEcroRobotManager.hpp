...
#ifndef __RD_ECRO_ROBOT_MANAGER_HPP__
#define __RD_ECRO_ROBOT_MANAGER_HPP__
 ...
 *
 * @brief The Robot Manager for the Ecro robot.
 *
 */
class RdEcroRobotManager : public RdRobotManager
{
    public:

        RdEcroRobotManager(const int& playerId) : RdRobotManager(playerId) { }
...
#endif //-- __RD_ECRO_ROBOT_MANAGER_HPP__
